...
function Header() {
  return (
    <div
     style={{ backgroundImage: `url(${assets.indianflag})`  }} className="flex bg-cover bg-center flex-col  md:flex-row flex-wrap rounded-lg px-6 md:px-10 lg:px-20">
      {/* left side */}
      <div className="md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px] ">
        ...
        <a href="#speciality" className="flex items-center justify-center gap-2 bg-green-800 px-8 py-3 rounded-full text-white font-bold text-sm md:m-0 m-auto hover:scale-110 transition-all duration-300">
          Book Appointment <FaArrowRightLong className="text-white" />
        </a>
      </div>
      {/* right side */}
       {/* 59:25 */}
